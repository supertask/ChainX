...
var NodeListServer = require('./NodeListServer.js');
var ylog = require("./cclog.js").ylog;

//setup
var httpServer = null;
var httpsServer = null;

//WebSocket server I made
new NodeListServer().run();


if (config.httpConfig) {
    httpServer = http.createServer();
    httpServer.listen(config.httpConfig.port, function () { ylog('Listening on ' + httpServer.address().port); });
}
if (config.httpsConfig) {
    ...
    httpsServer.listen(config.httpsConfig.port, function () { ylog('Listening on ' + httpsServer.address().port); });
}
